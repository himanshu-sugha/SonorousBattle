...
async def handle_genre_selection(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Search for tracks in the specified genre
        ...
        q=genre, type="video", part="id,snippet", maxResults=10
        ).execute()
    ...
    # messageToSendToCallBack = (
    # f"Vote for your favorite track below:\n\n"
    # f"🎵 **Track 1:** {track1_name} by {creator1}\n"
    # f"[![Track 1 Thumbnail]({track1_thumbnail})]({track1_preview})\n"  # Clickable image
    # f"🎵 **Track 2:** {track2_name} by {creator2}\n"
    # f"[![Track 2 Thumbnail]({track2_thumbnail})]({track2_preview})\n"
    # )
...
#             # Prepare the startBattle message with delay parameter
#             start_battle_request = {
#                 "type": "startBattle",
#                 "payload": {
#                     "track1": "Husn",
#                     "track2": "Naina (From Crew)",
#                     "creatorTrack1": "0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f",
#                     "creatorTrack2": "0xdF3e18d64BC6A983f673Ab319CCaE4f1a57C7097",
#                     "userAddress": "0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f",
#                     "paymentAmount": 10,
#                     "delay": 10000  # 10 seconds delay, adjustable
#                 }
#             }

#             # Send the request to start a battle
#             await websocket.send(json.dumps(start_battle_request))
#             print("Battle initiation request sent.")

#             # Listen for the acknowledgment response immediately
#             acknowledgment = await websocket.recv()
#             acknowledgment_data = json.loads(acknowledgment)
#             if acknowledgment_data.get("type") == "battleAcknowledgment":
#                 print("Acknowledgment Received:")
#                 print(acknowledgment_data.get("payload").get("message"))
#                 print("Battle Details:", acknowledgment_data.get("payload").get("battleDetails"))
...
#                     print("Battle Result Received:")
#                     print("Winner Details:", data.get("payload"))
#                     break
